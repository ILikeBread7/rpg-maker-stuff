//=============================================================================
// ILB_MessageWindowBackSprite.js.js
//=============================================================================
...
(function() {
    ...
    var parameters = PluginManager.parameters('ILB_MessageWindowBackSprite');
    ...
    Window_Message.prototype.initialize = function() {
        ...
        this._ILB_sprite = new Sprite();
        this._ILB_sprite.initialize(_image[_currentImage]);
        this._ILB_sprite.visible = false;
        this._ILB_sprite.move(imageX, imageY);
        this.addChildToBack(this._ILB_sprite);
    }
    ...
    Window_Message.prototype.startMessage = function() {
        ...
        if (skin !== 0) {
            if (_currentImage !== skin - 1) {
                ...
                this._ILB_sprite.bitmap = _image[_currentImage];
            }
            // Display only when background type is Window
            // 0 = type Window
            this._ILB_sprite.visible = $gameMessage.background() === 0;
        }
