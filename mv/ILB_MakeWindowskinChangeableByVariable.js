//=============================================================================
// ILB_MakeWindowskinChangeableByVariable.js
//=============================================================================
...
(function() {
    ...
    var parameters = PluginManager.parameters('ILB_MakeWindowskinChangeableByVariable');
    var skinsNumber = Number(parameters['Number of skins'] || 2);
    var skinsVarId = Number(parameters['Skin var ID'] || 1);

    Window_Base.prototype.loadWindowskin = function() {
        this._ILB_windowskins = [ ImageManager.loadSystem('Window') ];
        for (var i = 1; i <= skinsNumber; i++) {
            this._ILB_windowskins.push(ImageManager.loadSystem('Window_' + i));
        }
        this.windowskin = this._ILB_windowskins[0];
    };
    ...
    Window_Base.prototype.update = function() {
        ...
        this.windowskin = this._ILB_windowskins[currentSkin];
    }
