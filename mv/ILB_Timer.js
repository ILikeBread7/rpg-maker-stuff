 ...
 * 
 * Plugin Command:
 *   ILB_Timer start # Starts the timer and saves the start time in miliseconds to the provided variable
 *   ILB_Timer stop  # Stops the timer and saves the elapsed time in minutes:seconds.miliseconds format to the provided variable
 */

(function() {

    var parameters = PluginManager.parameters('ILB_Timer');
